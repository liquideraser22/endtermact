...
<form action="pro_create.php" method="POST">
	...
	Name:<br/><input class="w3-input w3-border w3-round-large w3-display-middle" type="text" name="name" placeholder="Enter Product Name"/><br/><br/>
	...
	<br/><br/><input class="w3-button w3-right w3-round-large w3-green" type="submit" name="submit" value="Create Product"/>
</script>
</form>
</div>
</html>
