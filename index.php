...
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Kanit:800i|Oswald|Teko:600&display=swap">
	 <div class="w3-bar-block w3-dark-grey w3-center w3-margin w3-round">
			...
			<li class="w3-bar-block w3-large w3-button w3-green w3-hover-white  w3-text-decoration-none; text-align: center;"><a href="page=show_product&id=<?php echo $result['id'];?>">Description</a></li>
