...
<div class="w3-container w3-margin w3-round">
	...
	<input class="w3-border w3-right w3-round-large" type="text"name="search" placeholder="Search product name"><i class='fa fa-search'></i>
		<button class="w3-right w3-button w3-light-grey w3-round w3-animate-zoom" type="submit" name="submit"></button>
		</div>	
	</form>
	<hr/>
